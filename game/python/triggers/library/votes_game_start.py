...
def check():
    ...
    # Check that server is in game-play mode
...
def execute():
    ...
    # Set votes to game started state
    core.CvarSetValue('sv_allowConcedeVotes', 0)
    core.CvarSetValue('sv_allowDrawVotes', 1)
    core.CvarSetValue('sv_allowElectVotes', 1)
    core.CvarSetValue('sv_allowImpeachVotes', 1)
    core.CvarSetValue('sv_allowKickVotes', 1)
    core.CvarSetValue('sv_allowMapVotes', 0)
    core.CvarSetValue('sv_allowMsgVotes', 1)
    core.CvarSetValue('sv_allowMuteVotes', 1)
    core.CvarSetValue('sv_allowNextMapVotes', 0)
    ...
    core.CvarSetValue('sv_allowShuffleVotes', 1)
    core.CvarSetValue('sv_allowTimeVotes', 1)
